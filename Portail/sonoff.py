...
class Sonoff():
    ...
    def do_login(self):
        ...
        r = requests.post('https://{}-api.coolkit.cc/api/user/login'.format(self._api_region),
    ...
    def update_devices(self):
        ...
        r = requests.get('https://{}-api.coolkit.cc/api/user/device'.format(self._api_region),
    ...
    def _get_ws(self):
        ...
        if self._ws is None:
            try:
                self._ws = create_connection(('wss://{}/api/ws'.format(self._wshost)), timeout=10)
